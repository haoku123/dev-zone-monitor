...
const validationErrors = computed(() => {
  ...
  if (economicData) {
    ...
    if (economicData.industrialEnterpriseTax < 0) errors.push('工业企业税收总额不能为负数')
  }
  ...
  if (enterpriseData) {
    if (enterpriseData.totalEnterprises < 0) errors.push('工商企业数量不能为负数')
    if (enterpriseData.industrialEnterprises < 0) errors.push('工业企业数量不能为负数')
    if (enterpriseData.totalEnterprises > 0 && enterpriseData.industrialEnterprises > enterpriseData.totalEnterprises) {
      errors.push('工业企业数量不能超过工商企业数量')
    }
  }
...
const getFieldDisplayName = (field) => {
  const nameMap = {
    ...
    'economicData.industrialEnterpriseTax': '工业企业税收总额',
    ...
    'enterpriseData.totalEnterprises': '工商企业数量',
    'enterpriseData.industrialEnterprises': '工业企业数量'
  }
